...
@export_file("*.tscn") var to_street := "res://scenes/Levels/Street.tscn"
@export_file("*.tscn") var to_cave := "res://scenes/Levels/cave_level.tscn"
@export_file("*.tscn") var to_boss := "res://scenes/Levels/boss.tscn"
